...
public class RealTimeCalculator extends Calculator_or_Stepbystep_Menu implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<String> InsertionPlaneOptions = new ArrayList<>();
        ...
        ArrayAdapter<String> adapterPlane = new ArrayAdapter<>(this, android.R.layout.simple_spinner_dropdown_item, InsertionPlaneOptions);
        ...
        List<String> RelativePositionOptions = new ArrayList<>();
        RelativePositionOptions.add("Select from Drop Down Menu");
        RelativePositionOptions.add("On Centreline");

        ArrayAdapter<String> adapterRelPos = new ArrayAdapter<>(this, android.R.layout.simple_spinner_dropdown_item, RelativePositionOptions);
